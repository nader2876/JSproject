...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveFormToDatabase(e) {
        ...
        showConfirm("Save Form", "Are you sure you want to save this form?")
            .then((result) => {
                if (result.isConfirmed) {
                    ...
                    const now = new Date();
                    const newForm = {
                        id: database.forms ? (database.forms.length + 1) : 1,
                        title: title,
                    ...
                    // window.location.href = 'forms_list.html';
                }
            });
    }

    // Database functions (moved from your admin.js)
    ...
    function initializeDatabase() {
        ...
        if (savedDB) {
            ...
            fetch('JS/db.json')
                ...
                .then(jsonData => {
                    Object.assign(database, jsonData);
    ...
    // Save Form button event listener
